...
public class ContextPopupMenuItem extends JMenuItem {
    String content = "";

    public ContextPopupMenuItem(String menu, String content) {
        this(menu, content,"");
    }

    public ContextPopupMenuItem(String menu, String content, String tooltip) {
        super(menu);
